...
[![CI](https://github.com/magarcia/ccsession-viewer/actions/workflows/ci.yml/badge.svg)](https://github.com/magarcia/ccsession-viewer/actions/workflows/ci.yml)
...
```bash
go install github.com/magarcia/ccsession-viewer@latest
```

Or download a pre-built binary from [GitHub Releases](https://github.com/magarcia/ccsession-viewer/releases).
